...
import {
  Phone, Mail, MapPin, Clock, Send, CheckCircle, User, Building2, MessageSquare
} from "lucide-react";
  ...
  return (
    <>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 md:gap-6 mb-6 md:mb-10">
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-3 md:gap-4 p-4 md:p-5 bg-gray-50 rounded-xl md:rounded-2xl border border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-xs md:text-base">Mo-Fr: 9-18 Uhr</p>
                    <p className="text-gray-700 text-xs md:text-base">Nach Vereinbarung</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="card-elevated p-5 md:p-8 lg:p-10">
                {isSubmitted ? (
                  ...
                  <>
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-1 md:mb-2">Schreiben Sie uns</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                      ...
                      <button type="submit" className="btn-primary w-full py-3 md:py-4 text-sm md:text-lg">
      ...
      <section className="h-[250px] md:h-[400px] bg-gray-200 relative">
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-green-700 to-green-800">
          <div className="text-center text-white">
            <Building2 className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 opacity-50" />
            <p className="text-base md:text-xl font-medium opacity-80">Nürnberg und Umgebung</p>
          </div>
        </div>
      </section>
    </>
