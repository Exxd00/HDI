...
import {
  ...
  Clock, Award, MapPin, Mail, ChevronRight, Quote, Star, Zap, Target
} from "lucide-react";
...
const testimonials = [
  { name: "Familie Müller", location: "Nürnberg-Langwasser", text: "Herr Böhm hat sich wirklich Zeit genommen, unsere Situation zu verstehen. Die Beratung war ehrlich und ohne Verkaufsdruck. Wir fühlen uns jetzt rundum abgesichert.", rating: 5 },
  { name: "Thomas K.", location: "Fürth", text: "Nach dem Hauskauf brauchten wir schnell eine gute Absicherung. Werner Böhm hat uns perfekt beraten und alles verständlich erklärt. Absolute Empfehlung!", rating: 5 },
  { name: "Dr. Sarah Weber", location: "Erlangen", text: "Als Ärztin war mir eine professionelle Beratung zur PKV wichtig. Herr Böhm kannte alle Details und hat den optimalen Tarif für mich gefunden.", rating: 5 },
];
        ...
        <div className="container-custom relative">
          ...
          <div className="mt-10 md:mt-16 text-center">
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              ...
              <Link href="/kontakt" className="btn-white text-sm md:text-lg py-3 px-5 md:py-4 md:px-8">
                Online Termin
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
              </Link>
            </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
            {testimonials.map((testimonial, idx) => (
              <div key={idx} className={`card-elevated p-4 md:p-8 ${idx === 2 ? 'col-span-2 md:col-span-1' : ''}`}>
                <div className="flex items-center gap-0.5 md:gap-1 mb-3 md:mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 md:w-5 md:h-5 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
                <Quote className="w-6 h-6 md:w-8 md:h-8 text-green-200 mb-3 md:mb-4" />
                <p className="text-gray-700 text-sm md:text-base mb-4 md:mb-6 leading-relaxed line-clamp-4 md:line-clamp-none">"{testimonial.text}"</p>
                <div className="flex items-center gap-2 md:gap-3 pt-3 md:pt-4 border-t border-gray-100">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-white font-bold text-sm md:text-base">
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 md:mt-12 text-center">
              ...
              <Link href="/kontakt" className="btn-secondary text-sm md:text-base py-3 px-5 md:py-4 md:px-7">
                Kontakt aufnehmen
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
              </Link>
            </div>
        ...
        <div className="container-custom relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-8 md:mb-12">
              ...
              <Link href="/kontakt" className="btn-white text-sm md:text-lg px-6 md:px-10 py-3 md:py-4">
